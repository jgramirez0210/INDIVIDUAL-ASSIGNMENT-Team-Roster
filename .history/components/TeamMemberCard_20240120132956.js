...
function TeamMemberCard({ teamMemberObj, onUpdate }) {
  ...
  return (
    <Card style={{ width: '18rem', margin: '10px' }}>
      {teamMemberObj && <Card.Img variant="top" src={teamMemberObj.image} alt={teamMemberObj.title} style={{ height: '400px' }} />}
      <Card.Body>
        <Card.Title>{teamMemberObj && teamMemberObj.title}</Card.Title>
