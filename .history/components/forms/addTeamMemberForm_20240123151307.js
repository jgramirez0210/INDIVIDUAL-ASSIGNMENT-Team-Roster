...
import { updatePlayer } from '../../api/teamData';
import { getPlayer } from '../../api/authorData';
import { createPlayer, updatePlayer } from '../../api/bookData';
...
function AddTeamMemberForm({ obj }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (obj.firebaseKey) {
      updatePlayer(formInput).then(() => router.push(`/team/${obj.firebaseKey}`));
    } else {
